      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto px-4 py-32">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="text-blue-800 mb-6 text-6xl font-bold  ">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-xs">Free forever: no payments required</p>
            </div>
          </div>
        </section>
        ...
        {/* Features Section */}
        <section className="border-t bg-white py-24 px-16">
